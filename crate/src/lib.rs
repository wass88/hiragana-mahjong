...
//!
//! ルール:
//! - 牌 = ひらがな 81 種 (清音46 / 濁音20 / 半濁音5 / 小書き9 / 長音1)、各4枚
...
pub const KANA: &str = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをんがぎぐげござじずぜぞだぢづでどばびぶべぼぱぴぷぺぽぁぃぅぇぉっゃゅょー";
pub const N_KINDS: usize = 81;
